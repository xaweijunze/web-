...
Tool.prototype = {//方法是定义在Tool的prototype上的；
    ...
    /*经常用到的函数*/
    getElementsByClassName: function (context,cName) {//获取元素的ClassName 返回数组
        var context = context || document;
        var ary = [];
        if (this.flag) {
            return this.listToArray(context.getElementsByClassName(cName));//伪数组转换成数组
        }
        var allNode = context.getElementsByTagName("*"); //先获取所有元素
